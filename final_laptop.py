...
def draw_tutorial_page(tabs):
    ...
    cv2.putText(
        background,
        "- Use 1 finger to navigate and click",
        (35, 100),
        font,
        0.5,
        white,
    ...
    cv2.putText(
        background,
        "- Use 2 fingers to adjust the brightness of the LEDs, speed of the",
        (35, 140),
        font,
        0.5,
        white,
    ...
    cv2.putText(
        background,
        "  -> Make sure to have your fingers inside the box displayed",
        (35, 220),
        font,
        0.5,
        white,
...
def draw_home_page(tabs):
    ...
    cv2.putText(background, "Quit", (580, 400), font, 0.5, white, 1, cv2.LINE_AA)
...
def draw_power_page(tabs):
    ...
    # Draw Colors Options
    cv2.putText(background, "ON/OFF", (235, 75), font, 0.5, white, 1, cv2.LINE_AA)
    cv2.putText(background, colors[0], (35, 150), font, 0.5, white, 1, cv2.LINE_AA)
    cv2.putText(background, colors[1], (35, 225), font, 0.5, white, 1, cv2.LINE_AA)
    cv2.putText(background, colors[2], (35, 300), font, 0.5, white, 1, cv2.LINE_AA)
    cv2.putText(background, colors[3], (35, 375), font, 0.5, white, 1, cv2.LINE_AA)
    # Draw Power
    if red_light:
        cv2.putText(background, "ON", (235, 150), font, 0.5, white, 1, cv2.LINE_AA)

    else:
        cv2.putText(background, "OFF", (235, 150), font, 0.5, white, 1, cv2.LINE_AA)

    if blue_light:
        cv2.putText(background, "ON", (235, 225), font, 0.5, white, 1, cv2.LINE_AA)

    else:
        cv2.putText(background, "OFF", (235, 225), font, 0.5, white, 1, cv2.LINE_AA)

    if green_light:
        cv2.putText(background, "ON", (235, 300), font, 0.5, white, 1, cv2.LINE_AA)

    else:
        cv2.putText(background, "OFF", (235, 300), font, 0.5, white, 1, cv2.LINE_AA)
    if yellow_light:
        cv2.putText(background, "ON", (235, 375), font, 0.5, white, 1, cv2.LINE_AA)

    else:
        cv2.putText(background, "OFF", (235, 375), font, 0.5, white, 1, cv2.LINE_AA)
...
def draw_brightness_page(tabs):
    ...
    cv2.putText(background, colors[0], (85, 105), font, 0.5, white, 1, cv2.LINE_AA)
    cv2.rectangle(background, (85, 125), (285, 250), white, 2)
    cv2.putText(background, colors[1], (390, 105), font, 0.5, white, 1, cv2.LINE_AA)
    cv2.rectangle(background, (390, 125), (590, 250), white, 2)
    cv2.putText(background, colors[2], (85, 280), font, 0.5, white, 1, cv2.LINE_AA)
    cv2.rectangle(background, (85, 300), (285, 425), white, 2)
    cv2.putText(background, colors[3], (390, 280), font, 0.5, white, 1, cv2.LINE_AA)
...
def draw_song_page(tabs):
    ...
    for i in range(len(music_files)):
        ...
        cv2.putText(
            background, music_files[i], text_position, font, 0.5, white, 1, cv2.LINE_AA
        )
...
def draw_fan_page(tabs):
    ...
    cv2.rectangle(background, (240, 110), (580, 400), white, 2)
    if motor_on:
        cv2.putText(background, "ON", (35, 110), font, 0.5, white, 1, cv2.LINE_AA)

    else:
        cv2.putText(background, "OFF", (35, 110), font, 0.5, white, 1, cv2.LINE_AA)
            ...
            while not_quit:
                ...
                if output is not None:
                    ...
                    if time.time() - start_time > 2:
                        handle_mouse_event(output[1][0], output[1][1], output[0])

                # Combine & Display the navigation bar with the camera frame
                combined_frame = cv2.addWeighted(frame1, 0.4, background, 0.6, 0)
                ...
                flipped_image = pygame.transform.flip(rotated_screen, True, False)
